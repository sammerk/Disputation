...
* Und infolge dessen insbesondere die Rolle epistemischer Überzeugungen für die Wahrnehmung der Theorie-Praxis-Integration untersucht
...
* Epistemische Überzeugungen prädizieren die Theorie-Praxis-Integration bildungswissenschaftlicher Gegenstände nach Kontrolle motivationaler und affektiver Variablen [@Merk2016g]

## Interaktives Datenbeispiel
...
$X_{ij}^{w/b}$ = within/between-Variable X bezüglich Gegenstand i und Person j; tp = TP = Theorie-Praxis-Relation; tr = TR = theorienspezifischer Relativismus; CM = Cognitive Theory of Multimedia Learning; BF = Big Fish Little Pond Effect; BM = Bullying Mobbing; IN = Inklusion; GT = Ganztagesschule.
Alle durchgezogenen Modellpfade sind bei p = .05 signifikant.
...
<center><img src="Img/COPES.svg" height="450px" /></center>
<div class="centered">
